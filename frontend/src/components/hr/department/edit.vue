              ...
              <div class="j-pro" id="j-pro">
                <div class="j-content">
                  ...
                  <div class="j-unit">
                    ...
                    <div class="j-input">
                      <label class="j-icon-right" for="Permissions">
                        <i class="icofont icofont-location-pin"></i>
                      </label>
                      <input type="text" id="Permissions" v-model="form.slug">
...
export default {
  ...
  methods: {
    async getData () {
      const response = await ModuleService.show({
    ...
    async update () {
      await ModuleService.update(this.form)
      this.$swal({
        type: 'success',
