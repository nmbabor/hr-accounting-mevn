      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header card-info">
            Employee Termination Show
            <div class="card-btn pull-right">
              <button class="btn btn-sm btn-primary" v-print="'#printThis'"><i class="fa fa-print"></i> Print</button>
              <router-link tag="a" to="/termination" class="btn btn-success btn-sm"><i class="fa fa-list"></i> View All</router-link>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-10" id="printThis">
                <div class="table-responsives">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <h5 class="text-center"> Details of Termination</h5>
                      <hr>
                    </div>
                    <div class="col-md-12">
