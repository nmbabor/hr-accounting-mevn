      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header card-info">
            Employee Transfer Show
            <div class="card-btn pull-right">
              <button class="btn btn-sm btn-primary" v-print="'#printThis'"><i class="fa fa-print"></i> Print</button>
              <router-link tag="a" to="/transfer" class="btn btn-success btn-sm"><i class="fa fa-list"></i> View All</router-link>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-5" style="width: 40%;float: left">
                      <table class="table table-bordered">
                        ...
                        <tr>
                          <th class="text-right" width="20%"> Old Regiment : </th>
                          <td> {{form.regiment.name}}  </td>
                        </tr>
                    ...
                    <div class="col-md-5" style="width: 40%;float: right">
                      <table class="table table-bordered">
                        ...
                        <tr>
                          <th class="text-right" width="20%"> Trasnferred to ( Regiment ) : </th>
                          <td> {{form.transferred.name}}  </td>
                        </tr>
                      </table>
                    </div>
                  </div>
