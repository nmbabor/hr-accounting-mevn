          ...
          <div class="card-body table-responsive">
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tr v-for="(data,index) in allData" :key="index">
                ...
                <td>
                  <router-link tag="a" v-bind:to="{ name: 'budgetShow', params: { id: data._id } }" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></router-link>
                  <router-link v-if="data.distribution_status===0" tag="a" v-bind:to="{ name: 'budgetEdit', params: { id: data._id } }" class="btn btn-xs btn-info"><i class="fa fa-edit"></i></router-link>
                </td>
